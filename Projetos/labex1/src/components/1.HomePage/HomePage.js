...
return (
    <Pagina>
        ...
        <LogoInscricao>Verifique as nossas viagens e faça já sua inscrição!</LogoInscricao>
        <BotaoInscricao onClick={goToListTripsPage}>QUERO CONHECER O ESPAÇO!</BotaoInscricao>
