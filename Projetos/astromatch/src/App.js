...
import Inicial from './components/tela inicial/Inicial.js'
import Matches from './components/tela matches/Matches.js'

function App() {

  const baseURL = "https://us-central1-missao-newton.cloudfunctions.net/astroMatch/luanaferreira/clear"
